...
pub const PAYLOAD_TYPE_KEY_ROTATION: u8 = 16;
pub const PAYLOAD_TYPE_CUSTODIAN_CONTRACT: u8 = 17;
pub const PAYLOAD_TYPE_CUSTODIAN_DELEGATION_REQ: u8 = 18;
pub const PAYLOAD_TYPE_CA_CAPABILITIES_PROOF: u8 = 19;
pub const PAYLOAD_TYPE_SWARM_ACTIVATION: u8 = 20;
